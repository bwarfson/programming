...
using System.Linq;
using pluralsight_dp_strategy.business.strategies.Invoices;
using pluralsight_dp_strategy.business.strategies.SalesTax;


namespace pluralsight_dp_strategy.business.models
{
    public class Order
    {
